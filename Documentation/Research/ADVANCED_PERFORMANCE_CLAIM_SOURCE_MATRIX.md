...
| `ADV-CLM-033` | CE Feedback, CE Feedback für Ausdrücke und DOP Feedback sind getrennte Feedbackmechanismen mit eigenen Voraussetzungen und beobachtbaren Zuständen. | `DOCUMENTED` | `SRC-007`, `SRC-008`, `SRC-061` | – | `OPT-006`, `RES-002`, `DGN-003` | Basisfeedback ab SQL Server 2022; Ausdrucksfeedback SQL Server 2025 mit CL 160+; 2019 `SKIP`. |
...
| `ADV-CLM-036` | Extended Events liefern ereignisbezogene Evidenz; Event-, Action-, Predicate-, Target- und Zeitraumwahl bestimmen Kosten und Aussage. | `DOCUMENTED` + `METHOD` | `SRC-028`, `SRC-060` | `SRC-051` | `DGN-005`, `DGN-007` | begrenzte Ring-Buffer-Session, ab 2025 optional `MAX_DURATION`, explizites Cleanup und fehlende Ereignisse korrekt interpretieren. |
