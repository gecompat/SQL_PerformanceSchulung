...
| `STL-009` | Commit-Batching und WRITELOG | Gelb | 1 | 2 | `TSQL_TESTDB` | `DISPOSABLE_INSTANCE` | `VALIDATED` |
| `RES-007` | Wait-Scope und zeitbezogene Deltas | Gelb | 3 | 2 | `TSQL_TESTDB` | `DISPOSABLE_INSTANCE` | `VALIDATED` |
...
| `QRY-013` | Anwendung langsam, SSMS schnell | M03 / `LO-M03-07` | Grün | `TSQL_TESTDB` | SQL Server 2019/CL150, 2022/CL160, 2025/CL170; je zwei Läufe | `VALIDATED` |
| `OPT-009` | Parametersensitive Planoptimierung | M03 / `LO-M03-08` | Grün | `TSQL_TESTDB` | SQL Server 2022/CL160 und 2025/CL170; 2019 kontrollierter `SKIP_VERSION`; je zwei Läufe | `VALIDATED` |
| `OPT-010` | Optional Parameter Plan Optimization | M03 / `LO-M03-08` | Grün | `TSQL_TESTDB` | SQL Server 2025/CL170; 2019 und 2022 kontrollierter `SKIP_VERSION`; je zwei Läufe | `VALIDATED` |
...
## Vertiefungs- und Abdeckungsdemos: Runtime-Stand
...
| `STL-009` | Commit-Batching und WRITELOG | M01 | Gelb | `TSQL_TESTDB` | SQL Server 2019/2022/2025; je zwei Läufe | `VALIDATED` |
| `RES-007` | Wait-Scope und zeitbezogene Deltas | M06 / `LO-M06-01/08` | Gelb | `TSQL_TESTDB` | SQL Server 2019/2022/2025; je zwei Läufe | `VALIDATED` |
