...
| `SRC-DECK-001` | `Presentations/Performance_Schulung_Chat_2026-07-23_2146_SQL_Server_Performance_Grundlagen.pptx` | PPTX | 102 Folien | `85bd14e4fc91d148889e9ebaa7128f6e1a213366f389aa6e2053f46cc0890ad3` | `45e31eb0792eaa355f34b200a7d6a1b2f61bf711` | neutraler Neuaufbau | `PASS` | aktive Präsentationsbasis; 102 eindeutige SlideKeys und drei native Custom Shows durch `PRS-012`, 84 Basisclaims durch `W2-007` sowie 18 Vertiefungsfolien durch `ADV-009` bis `ADV-011`; Sprecherhinweis zu `QRY-004` mit validierter Runtime-Evidenz synchronisiert und Folie 51 visuell bereinigt |
