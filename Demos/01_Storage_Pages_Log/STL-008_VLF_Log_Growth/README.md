...
Die vollständige Ausführung steht im [`DEMO_EXECUTION_GUIDE.md`](../../../Documentation/HowTo/DEMO_EXECUTION_GUIDE.md): `STL-008` auswählen, ausschließlich eine Wegwerf-Containerinstanz vorbereiten, den Recovery-Pfad prüfen und erst dann den manifestbasierten Aufruf mit `-AllowRed` ausführen. `SQLPERF_SUMMARY|PASS|OK`, VLF-/Growth-Evidenz und Cleanup prüfen. Nach Abbruch ausschließlich den markergebundenen Cleanup aus dem Leitfaden verwenden.
