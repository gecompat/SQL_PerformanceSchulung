#!/usr/bin/env python3
"""Run OPT-015 and OPT-016 twice against one SQL Server execution target."""
...
def run_demo(*, demo_id: str, manifest: Path, target: ExecutionTarget,
             repetition: int) -> None:
...
def main() -> int:
    ...
    try:
        ...
        print(f"ADV008_STAGE|ENGINE_{major}|IDENTITY|PASS|OK")
        ...
        print(
            f"ADV008_SUMMARY|PASS|OK|major={major}; demos=2; repetitions=2; "
        ...
        print(
            f"ADV008_SUMMARY|FAIL|FAIL_EXECUTION|major={major}; "
