...
## Projektspezifische Steuerung

Die verbindliche projektspezifische Lesereihenfolge beginnt in [`.ai/README.md`](.ai/README.md).
Die dort referenzierten Projektregeln, Entscheidungen, Demo-Verträge und Pläne bleiben für
Projektfakten, SQL-Server-spezifische Anforderungen, Datenschutzverschärfungen, Sprache,
Validierung und Implementierungsstand maßgeblich. Für Beiträge gilt zusätzlich
[`CONTRIBUTING.md`](CONTRIBUTING.md).

Die Foundation-Regeln bilden die gemeinsame Mindestbasis. Semantische Überschneidungen und
bewusste Projektentscheidungen sind in [`.ai/PROJECT_RULES.md`](.ai/PROJECT_RULES.md)
dokumentiert. Die Adapter für einzelne KI-Systeme dienen ausschließlich der Auffindbarkeit
dieses Einstiegspunkts.
